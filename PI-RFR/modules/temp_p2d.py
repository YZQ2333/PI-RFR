...
class temp_PartialConv2d(nn.Conv2d):
    def __init__(self, *args, **kwargs):
        ...
        super(temp_PartialConv2d, self).__init__(*args, **kwargs)
    ...
    def forward(self, input, mask=None):
        ...
        raw_out = super(temp_PartialConv2d, self).forward(
            (torch.mul(input, mask) + (1-mask)*254) if mask is not None else input)  # python3可以直接写super().xxx
